...
def search(request):
    if request.method == "POST":
        ...
        if not searched:
            messages.success(request, "No Results for this Search")
...
def update_password(request):
    if request.user.is_authenticated:
        ...
        messages.success(request, "You must Logg In to View that Page")
        return redirect('home')
...
def update_user(request):
    if request.user.is_authenticated:
        ...
        messages.success(request,"You must be Logged in to Update Account")
        return redirect('home')
